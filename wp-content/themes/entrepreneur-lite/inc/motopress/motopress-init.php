...
class MP_Entrepreneur_Motopress_Init {
...
// table
            ...
            if ($tableObj) {
                ...
                $styleClasses['predefined']['color']['values']['theme-silver'] = array(
                    ...
                    'label' => __('Light', 'entrepreneur-lite')
                );
...
// button inner
            ...
            if ($buttonGroupInnerObj) {
                ...
                $buttonGroupInnerObj->parameters['color']['list']['mp-theme-button-brand'] = __('Theme Brand', 'entrepreneur-lite');
                $buttonGroupInnerObj->parameters['color']['list']['mp-theme-button-white'] = __('Theme White', 'entrepreneur-lite');
...
// service box
            ...
            if ($serviceBoxObj) {
                ...
                $serviceBoxObj->parameters['icon_color']['list']['mp-theme-icon-brand'] = __('Theme Brand', 'entrepreneur-lite');
                $serviceBoxObj->parameters['icon_color']['default'] = 'mp-theme-icon-brand';
                $serviceBoxObj->parameters['button_color']['list']['mp-theme-button-brand'] = __('Theme Brand', 'entrepreneur-lite');
...
// call 
            ...
            if ($ctaObj) {
                ...
                $ctaObj->parameters['icon_color']['list']['mp-theme-icon-white'] = __('Theme Brand', 'entrepreneur-lite');
                $ctaObj->parameters['icon_color']['default'] = 'mp-theme-icon-white';
                $ctaObj->parameters['style']['list']['brand'] = __('Theme Brand', 'entrepreneur-lite');
                ...
                $ctaObj->parameters['button_color']['list']['mp-theme-button-white'] = __('Theme White', 'entrepreneur-lite');
...
// tab
        ...
        if ($tabObj) {
            $tabObj->parameters['icon_color']['list']['mp-theme-icon-brand'] = __('Theme Brand', 'entrepreneur-lite');
