...
class fellowDirectory{
    ...
    {
        $this->headerList = array('Name', 'Last Name', 'Current Firm', 'Country', 'Location', 'Fellowship', 'Class');
    ...
    protected function getData(){
         ...
         * Save data in json
         */
        if(!file_exists($this->filePath) && @filemtime($this->filePath) <  date('F d Y H:i:s',time() - 3600)) {
    ...
    protected function getContentHtml(){
        ...
        if (is_array($this->response)) {
            ...
            foreach ($this->response as $fellow) {
                ...
                $contentHTML .= '<tr>';
                $contentHTML .= '<td><a href="' . site_url() . '/index.php/fellow-bio?fellow=' . $fellow->Name . '">' . $names[0] . '</a></td>';
                $contentHTML .= '<td><a href="' . site_url() . '/index.php/fellow-bio?fellow=' . $fellow->Name . '">' . $lastName . '</a></td>';
