...
function get_salesforce_fellows($fellow = null, $email = null)
{
    ...
    try {
        ...
        if ($clean_email && !$clean_fellow) {
            ...
            $query = "SELECT Id,Name,LastName,Region__c,Fellowship__c,AccountId,Company_Name__c,Category__c,KFP_Class__c,MailingCountry,MailingState,MailingCity,Bio_Fellowship__c,Bio_Professional__c,Bio_Education_Personal__c FROM Contact WHERE KFP_Class__c='21' ORDER BY LastName";
        }
